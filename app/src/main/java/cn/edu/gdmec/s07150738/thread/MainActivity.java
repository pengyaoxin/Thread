package cn.edu.gdmec.s07150738.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void anr(View v){
        for (int i=0;i<100000;i++){
            BitmapFactory.decodeResource(getResources(),R.drawable.roid);
        }
    }
    ...
    public void timertask(View v){
        ...
        timer1.schedule(thread1,0,10000);
        timer2.schedule(thread2,5000,10000);
    }
           ...
           private int duration =10;
            ...
            protected String doInBackground(Long... longs) {
                ...
                while (count<duration){
                    num--;
                    count++;
                    String status = "高中毕业"+num+"秒，努力学习"+count+"秒";
